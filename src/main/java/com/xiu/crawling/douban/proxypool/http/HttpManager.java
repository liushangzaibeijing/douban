package com.xiu.crawling.douban.proxypool.http;
...
public class HttpManager {
    ...
    public String getResponseStr(String url) {
        ...
        return getResponseStr(url,null);
    }

    public String getResponseStr(String url,HttpHost proxy) {

        HttpGet request = new HttpGet(url);
        return getResponseStr(request,proxy);
    }

    public String getResponseStr(HttpRequestBase request,HttpHost proxy) {
        ...
        try {
            ...
            if (proxy == null) {
                ...
                response = createHttpClient(100000, proxy,null).execute(request, httpClientContext);
            }
